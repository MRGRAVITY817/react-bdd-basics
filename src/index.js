    ...
    return (
      <>
        ...
        <div className="App">
          ...
          <ContactList items={this.state.contacts} onAddClick={() => this.onAddClick(history)} onEditClick={(contact) => this.onEditClick(contact, history)} onDeleteClick={(contact) => this.onDeleteClick(contact, history)} />
        </div>
      </>
    )
  }
        ...
        <Navbar bg="black" variant="dark">
          <Container>
            <div className="playground-link">
              <a className="testing-talks-logo" href="/" data-id="header-logo"></a>
            </div>
            <div className="playground-link">
              <a className="ContactItemPlayground" data-id="playground-button" key="playground" href="/playground">
                PLAYGROUND
              </a>
            </div>
          </Container>
